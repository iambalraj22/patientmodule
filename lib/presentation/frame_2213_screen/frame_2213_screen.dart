import '../frame_2213_screen/widgets/listlabel_three2_item_widget.dart';
...
class Frame2213Screen extends GetWidget<Frame2213Controller> {
  @override
                    ...
                    child: Padding(
                      ...
                      child: Obx(
                        () => ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: controller.frame2213ModelObj.value
                              .listlabelThree2ItemList.length,
                          itemBuilder: (context, index) {
                            ListlabelThree2ItemModel model = controller
                                .frame2213ModelObj
                                .value
                                .listlabelThree2ItemList[index];
                            return ListlabelThree2ItemWidget(
                              model,
                            );
                          },
                        ),
