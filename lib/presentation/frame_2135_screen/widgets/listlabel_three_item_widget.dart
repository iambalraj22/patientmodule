...
class ListlabelThreeItemWidget extends StatelessWidget {
  ListlabelThreeItemWidget(this.listlabelThreeItemModelObj);

  ListlabelThreeItemModel listlabelThreeItemModelObj;

  var controller = Get.find<Frame2135Controller>();
