...
class Listtextfieldoutl1ItemWidget extends StatelessWidget {
  Listtextfieldoutl1ItemWidget(this.listtextfieldoutl1ItemModelObj);

  Listtextfieldoutl1ItemModel listtextfieldoutl1ItemModelObj;

  var controller = Get.find<CreateNewPasswordOneController>();
